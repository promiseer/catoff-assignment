...
```bash
git clone git@github.com:promiseer/catoff-assignment.git
```
...
Import [Postman Collection](catoff.postman_collection.json "catoff.postman_collection")  for api endpoints
